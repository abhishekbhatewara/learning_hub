      ...
      objectives: [

        {
          ...
          resources: [
            ...
            { type: "video", title: "What makes a hero? - Matthew Winkler (4 minutes)", provider: "📚 Library · youtube.com", url: "https://www.youtube.com/watch?v=Hhk4N9A0oCA", note: "From the Wolves classroom library." },
            { type: "video", title: "Starwars and Heros Journey (12 minutes)", provider: "📚 Library · youtube.com", url: "https://www.youtube.com/watch?v=4D_V3O5po-I", note: "From the Wolves classroom library." },
            { type: "video", title: "Story Study: Structure (ft. Harry Potter & the Philosopher's Stone) (7 minutes)", provider: "📚 Library · youtube.com", url: "https://www.youtube.com/watch?v=AlJb8BnpWJw", note: "From the Wolves classroom library." }
          ],
          quiz: [
...

        {
          ...
          resources: [
            ...
            { type: "book", enrichment: true, title: "How to Read Literature Like a Professor — For Kids", author: "Thomas C. Foster", chapter: "(e.g. 'Is That a Symbol?', 'It's All Political', 'Marked for Greatness')", note: "Enrichment read (great for ages 11–13): a fun guide to symbols, themes, character and the patterns behind great stories.", url: "https://openlibrary.org/search?q=how+to+read+literature+like+a+professor+for+kids" },
            { type: "video", title: "Analysis of Robert Frost's \"The Road Not Taken\" (1 minute)", provider: "📚 Library · youtube.com", url: "https://www.youtube.com/watch?v=fMcsadmTPoE", note: "From the Wolves classroom library." }
          ],
          quiz: [
...

        {
          ...
          resources: [
            ...
            { type: "book", enrichment: true, title: "How to Read Literature Like a Professor — For Kids", author: "Thomas C. Foster", chapter: "(e.g. 'Is That a Symbol?', 'It's All Political', 'Marked for Greatness')", note: "Enrichment read (great for ages 11–13): a fun guide to symbols, themes, character and the patterns behind great stories.", url: "https://openlibrary.org/search?q=how+to+read+literature+like+a+professor+for+kids" },
            { type: "video", title: "\"The Road Not Taken\" by Robert Frost (2 minutes)", provider: "📚 Library · youtube.com", url: "https://www.youtube.com/watch?v=yGB_K_xlHdI", note: "From the Wolves classroom library." }
          ],
          quiz: [
      ...
      objectives: [
...

        {
          ...
          resources: [
            ...
            { type: "book", enrichment: true, title: "The Elements of Eloquence: How to Turn the Perfect English Phrase", author: "Mark Forsyth", chapter: "(rhetorical figures, one per chapter)", note: "Enrichment read (accessible stretch): the rhetorical devices writers and advertisers use to make language persuasive and memorable.", url: "https://archive.org/details/the-elements-of-eloquence-how-to-turn-the-perfect-english-phrase" },
            { type: "video", title: "Why San Francisco is suing top U.S. food manufacturers over ultra-processed foods (7 minutes)", provider: "📚 Library · youtube.com", url: "https://www.youtube.com/watch?v=Gf97F3EyH7o", note: "From the Wolves classroom library." }
          ],
          quiz: [
      ...
      objectives: [

        {
          ...
          resources: [
            ...
            { type: "book", title: "Wren & Martin — High School English Grammar and Composition", author: "Wren & Martin (rev. N.D.V. Prasada Rao)", chapter: "Composition — Story-Writing", note: "This writing skill is covered in Wren & Martin's Composition section, 'Composition — Story-Writing'.", url: "https://openlibrary.org/search?q=wren+martin+high+school+english+grammar+and+composition" },
            { type: "book", enrichment: true, title: "On Writing: A Memoir of the Craft", author: "Stephen King", chapter: "(the 'Toolbox' and 'On Writing' craft sections)", note: "Enrichment read (advanced / with guidance): a celebrated author's practical advice on storytelling and the craft of writing.", url: "https://archive.org/details/onwritingmemoiro0000king" }
          ],
          quiz: [
...

        {
          ...
          resources: [
            ...
            { type: "book", title: "Wren & Martin — High School English Grammar and Composition", author: "Wren & Martin (rev. N.D.V. Prasada Rao)", chapter: "Composition — Paragraph-Writing", note: "This writing skill is covered in Wren & Martin's Composition section, 'Composition — Paragraph-Writing'.", url: "https://openlibrary.org/search?q=wren+martin+high+school+english+grammar+and+composition" },
            { type: "book", enrichment: true, title: "On Writing: A Memoir of the Craft", author: "Stephen King", chapter: "(the 'Toolbox' and 'On Writing' craft sections)", note: "Enrichment read (advanced / with guidance): a celebrated author's practical advice on storytelling and the craft of writing.", url: "https://archive.org/details/onwritingmemoiro0000king" }
          ],
          quiz: [
...

        {
          ...
          resources: [
            ...
            { type: "book", title: "Wren & Martin — High School English Grammar and Composition", author: "Wren & Martin (rev. N.D.V. Prasada Rao)", chapter: "Composition — Essay-Writing", note: "This writing skill is covered in Wren & Martin's Composition section, 'Composition — Essay-Writing'.", url: "https://openlibrary.org/search?q=wren+martin+high+school+english+grammar+and+composition" },
            { type: "book", enrichment: true, title: "On Writing: A Memoir of the Craft", author: "Stephen King", chapter: "(the 'Toolbox' and 'On Writing' craft sections)", note: "Enrichment read (advanced / with guidance): a celebrated author's practical advice on storytelling and the craft of writing.", url: "https://archive.org/details/onwritingmemoiro0000king" }
          ],
          quiz: [
...

        {
          ...
          resources: [
            ...
            { type: "book", title: "Wren & Martin — High School English Grammar and Composition", author: "Wren & Martin (rev. N.D.V. Prasada Rao)", chapter: "Composition — Speech-Writing", note: "This writing skill is covered in Wren & Martin's Composition section, 'Composition — Speech-Writing'.", url: "https://openlibrary.org/search?q=wren+martin+high+school+english+grammar+and+composition" },
            { type: "book", enrichment: true, title: "On Writing: A Memoir of the Craft", author: "Stephen King", chapter: "(the 'Toolbox' and 'On Writing' craft sections)", note: "Enrichment read (advanced / with guidance): a celebrated author's practical advice on storytelling and the craft of writing.", url: "https://archive.org/details/onwritingmemoiro0000king" }
          ],
          quiz: [
      ...
      objectives: [

        {
          ...
          resources: [
            ...
            { type: "book", title: "Wren & Martin — High School English Grammar and Composition", author: "Wren & Martin (rev. N.D.V. Prasada Rao)", chapter: "Parts of Speech", note: "This grammar point is covered in Wren & Martin's grammar section, 'Parts of Speech'.", url: "https://openlibrary.org/search?q=wren+martin+high+school+english+grammar+and+composition" },
            { type: "book", enrichment: true, title: "Eats, Shoots & Leaves", author: "Lynne Truss (children's edition available)", chapter: "(punctuation — commas, apostrophes & more)", note: "Enrichment read (great for ages 11–13): a witty tour of punctuation and why it really matters.", url: "https://openlibrary.org/search?q=eats+shoots+and+leaves+truss" }
          ],
          quiz: [
...

        {
          ...
          resources: [
            ...
            { type: "book", title: "Wren & Martin — High School English Grammar and Composition", author: "Wren & Martin (rev. N.D.V. Prasada Rao)", chapter: "The Adjective — Degrees of Comparison", note: "This grammar point is covered in Wren & Martin's grammar section, 'The Adjective — Degrees of Comparison'.", url: "https://openlibrary.org/search?q=wren+martin+high+school+english+grammar+and+composition" },
            { type: "book", enrichment: true, title: "Eats, Shoots & Leaves", author: "Lynne Truss (children's edition available)", chapter: "(punctuation — commas, apostrophes & more)", note: "Enrichment read (great for ages 11–13): a witty tour of punctuation and why it really matters.", url: "https://openlibrary.org/search?q=eats+shoots+and+leaves+truss" }
          ],
          quiz: [
...

        {
          ...
          resources: [
            ...
            { type: "book", title: "Wren & Martin — High School English Grammar and Composition", author: "Wren & Martin (rev. N.D.V. Prasada Rao)", chapter: "The Adverb", note: "This grammar point is covered in Wren & Martin's grammar section, 'The Adverb'.", url: "https://openlibrary.org/search?q=wren+martin+high+school+english+grammar+and+composition" },
            { type: "book", enrichment: true, title: "Eats, Shoots & Leaves", author: "Lynne Truss (children's edition available)", chapter: "(punctuation — commas, apostrophes & more)", note: "Enrichment read (great for ages 11–13): a witty tour of punctuation and why it really matters.", url: "https://openlibrary.org/search?q=eats+shoots+and+leaves+truss" }
          ],
          quiz: [
...

        {
          ...
          resources: [
            ...
            { type: "book", title: "Wren & Martin — High School English Grammar and Composition", author: "Wren & Martin (rev. N.D.V. Prasada Rao)", chapter: "The Sentence; Analysis of Sentences", note: "This grammar point is covered in Wren & Martin's grammar section, 'The Sentence; Analysis of Sentences'.", url: "https://openlibrary.org/search?q=wren+martin+high+school+english+grammar+and+composition" },
            { type: "book", enrichment: true, title: "Eats, Shoots & Leaves", author: "Lynne Truss (children's edition available)", chapter: "(punctuation — commas, apostrophes & more)", note: "Enrichment read (great for ages 11–13): a witty tour of punctuation and why it really matters.", url: "https://openlibrary.org/search?q=eats+shoots+and+leaves+truss" }
          ],
          quiz: [
...

        {
          ...
          resources: [
            ...
            { type: "book", title: "Wren & Martin — High School English Grammar and Composition", author: "Wren & Martin (rev. N.D.V. Prasada Rao)", chapter: "Analysis of Sentences — Clauses; The Conjunction", note: "This grammar point is covered in Wren & Martin's grammar section, 'Analysis of Sentences — Clauses; The Conjunction'.", url: "https://openlibrary.org/search?q=wren+martin+high+school+english+grammar+and+composition" },
            { type: "book", enrichment: true, title: "Eats, Shoots & Leaves", author: "Lynne Truss (children's edition available)", chapter: "(punctuation — commas, apostrophes & more)", note: "Enrichment read (great for ages 11–13): a witty tour of punctuation and why it really matters.", url: "https://openlibrary.org/search?q=eats+shoots+and+leaves+truss" }
          ],
          quiz: [
...

        {
          ...
          resources: [
            ...
            { type: "book", title: "Wren & Martin — High School English Grammar and Composition", author: "Wren & Martin (rev. N.D.V. Prasada Rao)", chapter: "Punctuation", note: "This grammar point is covered in Wren & Martin's grammar section, 'Punctuation'.", url: "https://openlibrary.org/search?q=wren+martin+high+school+english+grammar+and+composition" },
            { type: "book", enrichment: true, title: "Eats, Shoots & Leaves", author: "Lynne Truss (children's edition available)", chapter: "(punctuation — commas, apostrophes & more)", note: "Enrichment read (great for ages 11–13): a witty tour of punctuation and why it really matters.", url: "https://openlibrary.org/search?q=eats+shoots+and+leaves+truss" }
          ],
          quiz: [
...

        {
          ...
          resources: [
            ...
            { type: "book", title: "Wren & Martin — High School English Grammar and Composition", author: "Wren & Martin (rev. N.D.V. Prasada Rao)", chapter: "Analysis of Sentences — Kinds of Sentences", note: "This grammar point is covered in Wren & Martin's grammar section, 'Analysis of Sentences — Kinds of Sentences'.", url: "https://openlibrary.org/search?q=wren+martin+high+school+english+grammar+and+composition" },
            { type: "book", enrichment: true, title: "Eats, Shoots & Leaves", author: "Lynne Truss (children's edition available)", chapter: "(punctuation — commas, apostrophes & more)", note: "Enrichment read (great for ages 11–13): a witty tour of punctuation and why it really matters.", url: "https://openlibrary.org/search?q=eats+shoots+and+leaves+truss" }
          ],
          quiz: [
...

        {
          ...
          resources: [
            ...
            { type: "book", title: "Wren & Martin — High School English Grammar and Composition", author: "Wren & Martin (rev. N.D.V. Prasada Rao)", chapter: "The Preposition; The Phrase", note: "This grammar point is covered in Wren & Martin's grammar section, 'The Preposition; The Phrase'.", url: "https://openlibrary.org/search?q=wren+martin+high+school+english+grammar+and+composition" },
            { type: "book", enrichment: true, title: "Eats, Shoots & Leaves", author: "Lynne Truss (children's edition available)", chapter: "(punctuation — commas, apostrophes & more)", note: "Enrichment read (great for ages 11–13): a witty tour of punctuation and why it really matters.", url: "https://openlibrary.org/search?q=eats+shoots+and+leaves+truss" }
          ],
          quiz: [
...

        {
          ...
          resources: [
            ...
            { type: "book", title: "Wren & Martin — High School English Grammar and Composition", author: "Wren & Martin (rev. N.D.V. Prasada Rao)", chapter: "Punctuation — The Apostrophe", note: "This grammar point is covered in Wren & Martin's grammar section, 'Punctuation — The Apostrophe'.", url: "https://openlibrary.org/search?q=wren+martin+high+school+english+grammar+and+composition" },
            { type: "book", enrichment: true, title: "Eats, Shoots & Leaves", author: "Lynne Truss (children's edition available)", chapter: "(punctuation — commas, apostrophes & more)", note: "Enrichment read (great for ages 11–13): a witty tour of punctuation and why it really matters.", url: "https://openlibrary.org/search?q=eats+shoots+and+leaves+truss" }
          ],
          quiz: [
...

        {
          ...
          resources: [
            ...
            { type: "book", title: "Wren & Martin — High School English Grammar and Composition", author: "Wren & Martin (rev. N.D.V. Prasada Rao)", chapter: "Transformation & Synthesis of Sentences", note: "This grammar point is covered in Wren & Martin's grammar section, 'Transformation & Synthesis of Sentences'.", url: "https://openlibrary.org/search?q=wren+martin+high+school+english+grammar+and+composition" },
            { type: "book", enrichment: true, title: "Eats, Shoots & Leaves", author: "Lynne Truss (children's edition available)", chapter: "(punctuation — commas, apostrophes & more)", note: "Enrichment read (great for ages 11–13): a witty tour of punctuation and why it really matters.", url: "https://openlibrary.org/search?q=eats+shoots+and+leaves+truss" }
          ],
          quiz: [
